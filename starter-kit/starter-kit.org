...
** LigonLab Starter Kit Base
  #+begin_src emacs-lisp
  (starter-kit-load "starter-kit-ligonlab.org")
  #+end_src

  #+RESULTS:
  : Loaded /home/ligon/.emacs.d/starter-kit-ligonlab.el
...
After we've loaded all the Starter Kit defaults, let's load the User's stuff.
